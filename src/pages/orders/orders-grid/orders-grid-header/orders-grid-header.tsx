...
export const OrdersGridHeader: React.FC<{order : IOrder}> = ({ order }) => {
  ...
  let headerData: {
    ...
    childredStyles: [
      ...
      {title: 'Sale', style: {gridArea: '1 / 8 / 2 / 10', borderBottom: 'none', borderRight: 'none', textAlign: 'center', backgroundColor: '#e4f2fd'}},
      ...
      {title: 'Price, UZS', style: {gridArea: '2 / 8 / 3 / 9', borderRight: 'none', backgroundColor: '#e4f2fd'}},
      {title: 'Amount, UZS', style: {gridArea: '2 / 9 / 3 / 10', borderRight: 'none', backgroundColor: '#e4f2fd'}},
    ]
  }
  ...
  if (order.purchaseCurrencyName !== '') {
    headerData = {
      ...
      childredStyles: [
        ...
        {title: 'Sale', style: {gridArea: '1 / 10 / 2 / 12', borderBottom: 'none', borderRight: 'none', textAlign: 'center', backgroundColor: '#e4f2fd'}},
        ...
        {title: 'Price, UZS', style: {gridArea: '2 / 10 / 3 / 11', borderRight: 'none', backgroundColor: '#e4f2fd'}},
        {title: 'Amount, UZS', style: {gridArea: '2 / 11 / 3 / 12', borderRight: 'none', backgroundColor: '#e4f2fd'}},
      ]
    }
  }
